                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center">
                                <a href="{{ url('/teacher/student/' . $student->std_id . '/report/detail?semester=' . $semester->semesters->smt_id) }}" 
                                   class="btn btn-sm btn-primary">
                                     Info
                                </a>
                                <a href="{{ url('/teacher/student/' . $student->std_id . '/report/download?semester=' . $semester->semesters->smt_id) }}" 
                                   class="btn btn-sm btn-primary">
                                     Download
                                </a>
