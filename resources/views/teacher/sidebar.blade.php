    ...
    <div><!-- ---------------------------------- -->
        ...
        <nav class="sidebar-nav scroll-sidebar" data-simplebar>
            <ul id="sidebarnav">
                ...
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/teacher/schedule" id="get-url" aria-expanded="false">
                        <span>
                ...
                @if(auth()->user()->can('homeroom'))
                <li class="nav-small-cap">
                    <i class="ti ti-dots nav-small-cap-icon fs-4"></i>
                    <span class="hide-menu">Fitur Wali Kelas </span>
                </li>
                <li class="sidebar-item">
                    <a class="sidebar-link" href="/teacher/homeroom" id="get-url" aria-expanded="false">
                        <span>
                            <i class="ti ti-chalkboard"></i>

                        </span>
                        <span class="hide-menu"> Kelas Diampu</span>
                    </a>
                </li>
                @endif
